...
#插入 课程信息 到 课程表中
INSERT INTO `student`.`courses` (`courses_key`, `courses_name`, `courses_score`, `courses_information`, `ifCanChoose`, `courses_numberCanChoose`, `courses_numberChoose`) VALUES ('1', '高速退学', '6', '教3-101-周三1~2节', '1', '60', '6');
INSERT INTO `student`.`courses` (`courses_key`, `courses_name`, `courses_score`, `courses_information`, `ifCanChoose`, `courses_numberCanChoose`, `courses_numberChoose`) VALUES ('2', '云里物理', '3', '教5-202-周五3~4节', '1', '60', '3');
INSERT INTO `student`.`courses` (`courses_key`, `courses_name`, `courses_score`, `courses_information`, `ifCanChoose`, `courses_numberCanChoose`, `courses_numberChoose`) VALUES ('3', '生化危机', '4', '教3-303-周一6~7节', '0', '1', '1');
INSERT INTO `student`.`courses` (`courses_key`, `courses_name`, `courses_score`, `courses_information`, `ifCanChoose`, `courses_numberCanChoose`, `courses_numberChoose`) VALUES ('4', '爆炸艺术', '2', '教1-101-周二6~7节', '0', '2', '2');
INSERT INTO `student`.`courses` (`courses_key`, `courses_name`, `courses_score`, `courses_information`, `ifCanChoose`, `courses_numberCanChoose`, `courses_numberChoose`) VALUES ('5', '大学鹰语', '4', '教2-202-周四3~4节', '1', '60', '2');
INSERT INTO `student`.`courses` (`courses_key`, `courses_name`, `courses_score`, `courses_information`, `ifCanChoose`, `courses_numberCanChoose`, `courses_numberChoose`) VALUES ('6', '线性代考', '4', '教4-234-周一1~2节', '1', '20', '3');
INSERT INTO `student`.`courses` (`courses_key`, `courses_name`, `courses_score`, `courses_information`, `ifCanChoose`, `courses_numberCanChoose`, `courses_numberChoose`) VALUES ('7', '英语四年级', '1', '教2-316-周二1~2节', '1', '5', '1');


#插入 课程信息 到 选课表中
INSERT INTO `student`.`student_courses` (`sc_key`, `sc_name`, `sc_score`, `sc_information`) VALUES ('1', '高速退学', '6', '教3-101-周三1~2节');
INSERT INTO `student`.`student_courses` (`sc_key`, `sc_name`, `sc_score`, `sc_information`) VALUES ('2', '云里物理', '3', '教5-202-周五3~4节');
INSERT INTO `student`.`student_courses` (`sc_key`, `sc_name`, `sc_score`, `sc_information`) VALUES ('5', '大学鹰语', '4', '教2-202-周四3~4节');
INSERT INTO `student`.`student_courses` (`sc_key`, `sc_name`, `sc_score`, `sc_information`) VALUES ('6', '线性代考', '4', '教4-234-周一1~2节');
INSERT INTO `student`.`student_courses` (`sc_key`, `sc_name`, `sc_score`, `sc_information`) VALUES ('7', '英语四年级', '1', '教2-316-周二1~2节');
...
UPDATE `student`.`students` SET `phoneNumber` = '18300000985', `email` = 'y@y.com' WHERE (`id` = '4');
UPDATE `student`.`students` SET `email` = '3@3.com' WHERE (`id` = '1');
UPDATE `student`.`students` SET `email` = '4@4.com' WHERE (`id` = '2');
UPDATE `student`.`students` SET `email` = '5@5.com' WHERE (`id` = '3');
UPDATE `student`.`students` SET `email` = '7@7.com' WHERE (`id` = '5');
UPDATE `student`.`students` SET `email` = '8@8.com' WHERE (`id` = '6');
UPDATE `student`.`students` SET `email` = '9@9.com' WHERE (`id` = '7');

UPDATE `student`.`users` SET `phoneNumber` = '18300000003', `email` = '3@3.com' WHERE (`id` = '1');
UPDATE `student`.`users` SET `phoneNumber` = '13600000004', `email` = '4@4.com' WHERE (`id` = '2');
UPDATE `student`.`users` SET `phoneNumber` = '13600000005', `email` = '5@5.com' WHERE (`id` = '3');
UPDATE `student`.`users` SET `phoneNumber` = '12200007777', `email` = '7@7.com' WHERE (`id` = '5');
UPDATE `student`.`users` SET `phoneNumber` = '18300000006', `email` = '8@8.com' WHERE (`id` = '6');
UPDATE `student`.`users` SET `phoneNumber` = '13600000007', `email` = '9@9.com' WHERE (`id` = '7');
UPDATE `student`.`users` SET `phoneNumber` = '18300000985', `email` = 'y@y.com' WHERE (`id` = '4');
